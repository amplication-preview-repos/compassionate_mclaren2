...
import { ThemeSettingList } from "./themeSetting/ThemeSettingList";
import { ThemeSettingCreate } from "./themeSetting/ThemeSettingCreate";
import { ThemeSettingEdit } from "./themeSetting/ThemeSettingEdit";
import { ThemeSettingShow } from "./themeSetting/ThemeSettingShow";
    ...
    <div className="App">
      ...
      >
        ...
        <Resource
          ...
          edit={ThemeSettingEdit}
          create={ThemeSettingCreate}
          show={ThemeSettingShow}
        />
        <Resource
          name="User"
          list={UserList}
